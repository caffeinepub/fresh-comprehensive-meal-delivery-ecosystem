...
export default function App() {
  const [appType, setAppType] = useState<'customer' | 'delivery' | 'restaurant' | 'admin' | 'directory'>('directory');
  ...
  useEffect(() => {
    ...
    if (appParam && ['customer', 'delivery', 'restaurant', 'admin'].includes(appParam)) {
  ...
  const updateManifest = (type: 'customer' | 'delivery' | 'restaurant' | 'admin') => {
