...
import { LogIn, Utensils, Calendar, Truck, Mail, Phone, Shield, AlertCircle, CheckCircle2, Loader2 } from 'lucide-react';
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground">
                Your daily home-cooked meal delivery service. Fresh, healthy, and delivered to your doorstep.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 p-4 rounded-lg bg-fresh-50/50 dark:bg-fresh-950/20">
                ...
                <div>
                  <h3 className="font-semibold text-lg">Dabba Pickup Service</h3>
                  <p className="text-sm text-muted-foreground">
                    Schedule daily pickups for your home-cooked tiffins from home to office
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-4 rounded-lg bg-fresh-50/50 dark:bg-fresh-950/20">
                ...
                <div>
                  <h3 className="font-semibold text-lg">Restaurant Subscriptions</h3>
                  <p className="text-sm text-muted-foreground">
                    Subscribe to daily or weekly meal plans from your favorite home cooks
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-4 rounded-lg bg-fresh-50/50 dark:bg-fresh-950/20">
                  ...
                  <TabsContent value="email" className="space-y-4">
                    {!session || session.method !== 'email' ? (
                      ...
                      <form onSubmit={handleVerifyOtp} className="space-y-4">
                        ...
                        <Button type="submit" disabled={isVerifying || otp.length !== 6} size="lg" className="w-full">
                          {isVerifying ? (
                            <>
                              <Loader2 className="h-5 w-5 animate-spin mr-2" />
                              Verifying...
