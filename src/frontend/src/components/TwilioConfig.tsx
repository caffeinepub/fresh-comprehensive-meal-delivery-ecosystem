...
import { TwilioConfiguration } from '../backend';
...
export default function TwilioConfig() {
  ...
  const [accountSid, setAccountSid] = useState('AC57ded10611d2c9e54b65c84d8b034f1a');
  const [authToken, setAuthToken] = useState('1d8dbe0a7cce1c23130ca03f55736f88');
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Configure Twilio credentials to enable phone OTP login across all Fresh apps
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        {isConfigured ? (
          <Alert className="border-green-200 bg-green-50 dark:bg-green-950/20">
            ...
            <AlertDescription className="text-green-900 dark:text-green-100">
              Twilio SMS service is active. Phone OTP login is enabled for all apps.
            </AlertDescription>
          </Alert>
        ) : (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              Twilio SMS is not configured. Phone OTP login will not work until configured.
            </AlertDescription>
          </Alert>
        )}
        ...
        <Alert className="bg-blue-50 dark:bg-blue-950/20 border-blue-200">
          <AlertDescription className="text-sm">
            <strong>Note:</strong> Once configured, all Fresh apps (Customer, Delivery, Restaurant, Admin) 
            will be able to send SMS verification codes for phone number login. Make sure your Twilio 
            account has sufficient credits and the phone number is verified.
          </AlertDescription>
        </Alert>
      </CardContent>
    </Card>
