...
export default function RestaurantLoginPrompt() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-orange-50 via-background to-orange-100/50 px-4 py-12">
      <div className="container max-w-6xl">
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 p-4 rounded-lg bg-orange-50/50 dark:bg-orange-950/20">
                <UtensilsCrossed className="h-6 w-6 text-orange-600 flex-shrink-0 mt-1" />
                <div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg bg-orange-50/50 dark:bg-orange-950/20">
                <ImagePlus className="h-6 w-6 text-orange-600 flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-lg">Image Upload</h3>
                  <p className="text-sm text-muted-foreground">
                    Upload beautiful photos of your meals with progress tracking
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-4 rounded-lg bg-orange-50/50 dark:bg-orange-950/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Track incoming orders and monitor your revenue
                  </p>
                </div>
              </div>
            </div>
